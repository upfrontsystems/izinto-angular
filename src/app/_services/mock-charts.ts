...
export const CHARTS: Chart[] = [
    {
        index: 1, selector: 'temp-line', title: 'Temperature (°C)', unit: '°C', color: '#B5CF6B', type: 'Line',
        group_by: '1h',
    ...
    {
        index: 2, selector: 'rain-bar', title: 'Rainfall (mm)', unit: 'mm', color: '#3A7FA3', type: 'Bar',
        group_by: '1d',
    ...
    {
        index: 3, selector: 'air-line', title: 'Air Pressure (mbar)', unit: 'mbar', color: '#FC9E27', type: 'Line',
        group_by: '1d',
    ...
    {
        index: 4, selector: 'wind-speed-bar', title: 'Wind speed (m/s)', unit: 'm/s', color: '#E7BA52', fillFunc: windScale, type: 'Bar',
        group_by: '1d',
    ...
    {
        index: 5, selector: 'wind-dir-arrow', title: 'Wind direction', unit: '°', color: '#E7BA52', type: 'Wind Arrow',
        group_by: '1d',
