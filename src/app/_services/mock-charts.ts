...
export const CHARTS: Chart[] = [
    {
        ...
        group_by: '1h', dashboard_id: 1, data_source_id: 1, data_source: new DataSource(),
    ...
    },
    {
        ...
        group_by: '1d', dashboard_id: 1, data_source_id: 1, data_source: new DataSource(),
    ...
    },
    {
        ...
        fillFunc: windScale, type: 'Bar', group_by: '1d', dashboard_id: 1, data_source_id: 1, data_source: new DataSource(),
